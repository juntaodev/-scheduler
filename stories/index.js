...
storiesOf("InterviewerList", module)
  ...
  .add("Status", () => <Status status="Deleting" />)
  ...
  .add("Edit", () => <Form interviewer={interviewer.id} interviewers={interviewers} student="Raeme" onSave={action("onSave")} onCancel={action("onCancel")} />)
